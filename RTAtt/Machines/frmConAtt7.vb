...
#End Region
    ...
    Private Sub Load1stMachine()
        Try
            ...
            cmdDev.CommandText = "select machinename, ipaddress, port from tabledevice where machincenumber=7"
    ...
    Private Sub frmConAtt7_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Load1stMachine()
    End Sub
End Class