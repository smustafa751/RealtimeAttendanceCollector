...
#End Region
    Private Sub frmConAtt1_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Load1stMachine()
        'Load2ndMachine()
        'Load3rdMachine()
        'Load4thMachine()
    ...
    Private Sub Load1stMachine()
        Try
            ...
            cmdDev.CommandText = "select machinename, ipaddress, port from tabledevice where machincenumber=1"
    ...
    Private Sub Timer1_Tick(sender As System.Object, e As System.EventArgs) Handles Timer1.Tick
        ...
        ResetCounter = ResetCounter + Timer1.Interval
        If ResetCounter >= 7000 Then
            Label1.Text = "-"
            PictureBox1.Image = Nothing
            ResetCounter = 0
        End If
    ...
    Private Sub GoDemo()
        ...
        cmdSQL.CommandText = "select count(empno) from tabldemo where empno='" & sEmpID & "' and convert(date,timein)='" & Ds.ToString("MM/dd/yyyy") & "' and timeout is null"
        ...
        If Rec1 = 0 Then
            Ds2 = Ds2.AddDays(-1)
            cmdSQL.CommandText = "select count(empno) from tabldemo where empno='" & sEmpID & "' and convert(date,timein)='" & Ds2.ToString("MM/dd/yyyy") & "' and timeout is null"
            cmdSQL.Connection = CON1
            ...
            If PrevRec > 0 Then
                cmdSQL.CommandText = "update tabldemo set timeout='" & Ds.ToString("MM/dd/yyyy  HH:mm:ss") & "' where empno='" & sEmpID & "' and timeout is null and convert(date,timein)='" & Ds2.ToString("MM/dd/yyyy") & "'"
                cmdSQL.Connection = CON1
        ...
        cmdDup.CommandText = "select top 1 count(empno) from tabldemo where empno='" & sEmpID & "' and convert(date,timein)='" & Ds.ToString("MM/dd/yyyy  HH:mm:ss") & "' and convert(date,timeout)='" & Ds.ToString("MM/dd/yyyy  HH:mm:ss") & "'"
        ...
        If LastEntry = False Then
            If Duplicate = 0 Then
                If Rec1 = 0 And PrevRec = 0 Then
                    cmdSQL.CommandText = "insert into tabldemo (empno,timein)  values ('" & sEmpID & "','" & Ds.ToString("MM/dd/yyyy HH:mm:ss") & "')"
                    cmdSQL.Connection = CON1
                    cmdSQL.ExecuteScalar()
                Else
                    cmdSQL.CommandText = "update tabldemo set timeout='" & Ds.ToString("MM/dd/yyyy  HH:mm:ss") & "' where empno='" & sEmpID & "' and timeout is null and convert(date,timein)='" & Ds.ToString("MM/dd/yyyy") & "'"
                    cmdSQL.Connection = CON1
                    cmdSQL.ExecuteScalar()
    ...
    Private Sub Timer2_Tick(sender As System.Object, e As System.EventArgs) Handles Timer2.Tick
        ...
        Reseter = Reseter + Timer2.Interval
        If Reseter >= 10000 Then
            Reseter = 0
