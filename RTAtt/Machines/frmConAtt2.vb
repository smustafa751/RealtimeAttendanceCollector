...
#End Region
    ...
    Private Sub Load1stMachine()
        Try
            ...
            cmdDev.CommandText = "select machinename, ipaddress, port from tabledevice where machincenumber=2"
    ...
    Private Sub frmConAtt2_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Load1stMachine()
